...
export default function Hero() {
  return (
    <section className="flex flex-col md:grid md:grid-cols-[1fr_520px] px-2 md:px-24 bg-[#ededed] gap-y-10 md:gap-x-32">
      ...
      {/* TEXT */}
      <div className="order-2 md:order-1 w-full md:max-w-8xl space-y-4 md:space-y-6 flex flex-col items-center mt-0 md:mt-22 md:items-start text-center md:text-left">
  ...
  <div className="relative overflow-hidden border-4 border-[#ededed] shadow-lg w-36 h-36 sm:w-48 sm:h-48 
                  
                  /* Mobile styles for the desired shape */
                  rounded-none rounded-t-full rounded-b-full 
                  
                  /* Desktop styles: using arbitrary values for a precise elliptical curve on top and bottom */
                  md:rounded-none md:rounded-t-[50%] md:rounded-b-[50%]
                  md:w-[500px] md:h-[500px] lg:w-[1000px] lg:h-[800px] bg-white">
    <Image
      src="/Ayush.png"
      alt="Profile"
      fill
