...
export function Education({
  ...
  return (
    <section className="w-full bg-background py-16 px-4 md:px-8 lg:px-12 md:mt-20">
                ...
                <div key={year}>
                  ...
                  <div className="space-y-4">
                    {achievementsByYear[year].map((achievement) => (
                      <div
                        key={achievement.id}
                        className="bg-card border border-border rounded-lg p-5 flex gap-4 hover:shadow-md transition-shadow group"
                      >
                        {/* Icon */}
                        <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center grayscale group-hover:grayscale-0 transition-all duration-300">
                          {achievement.icon ? (
                            achievement.icon
                          ) : (
